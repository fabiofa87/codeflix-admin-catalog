...
class TestUpdateCategory:
    ...
    def category(self) -> Category:
        return Category(name="Movie", description="Movie category description", is_active=True)
    
    @pytest.fixture
    def mock_repository(self, category: Category) -> CategoryRepository:
        repository = create_autospec(CategoryRepository, instalce=True)
        repository.get_by_id.return_value = category
        return repository
    
    def test_update_category_name(self, mock_repository: CategoryRepository, category: Category):
    ...
    def test_update_description(self, mock_repository: CategoryRepository, category: Category):
        use_case = UpdateCategory(repository=mock_repository)
